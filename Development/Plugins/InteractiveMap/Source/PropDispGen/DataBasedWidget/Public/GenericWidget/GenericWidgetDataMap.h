...
public:
	...
	UPROPERTY(Category = StructWidgetMap, EditAnywhere, meta=(AllowedClasses="/Script/UMG.UserWidget", MustImplement="/Script/DataBasedWidget.PropGenDataDrivenUserWidgetInterface",
